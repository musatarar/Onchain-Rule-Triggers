...
FIRST VIEWPORT: The standard monitor header (wordmark + WORKING NAME), a tab strip with SIGN IN · NEW OPERATOR · EMAIL LINK, a full-tube noise field with a dim NO SIGNAL caption, and a centred 380px panel with USERNAME, PASSWORD and an inverse SIGN IN. The status line reads SIGNAL NONE · AWAITING OPERATOR.
